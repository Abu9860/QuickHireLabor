            ...
            <div class="report-section">
                ...
                <div class="stats-cards">
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-value">$<?php echo number_format($financialStats['total_payments'] ?? 0, 2); ?></p>
                    </div>
                    <div class="stat-card">
                        <h4>Average Job Cost</h4>
                        <p class="stat-value">$<?php echo number_format($financialStats['avg_job_cost'] ?? 0, 2); ?></p>
                    </div>
                    <div class="stat-card">
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-value">$<?php echo number_format($financialStats['pending_payments'] ?? 0, 2); ?></p>
                    </div>
                </div>
            </div>
