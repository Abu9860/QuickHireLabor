...
<body>
    ...
    <div class="container">
        ...
        <div class="quick-actions">
            <a href="c_post_job.php" class="action-btn">Post New Job</a>
            <a href="c_search_labor.php" class="action-btn">Find Laborers</a>
            <a href="c_job_status.php" class="action-btn">Track Jobs</a>
